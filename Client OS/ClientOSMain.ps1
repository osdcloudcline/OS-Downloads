...
do 
{
 ...
 '5' { cls
        $Win1125H2 = Invoke-WebRequest ("https://github.com/osdcloudcline/OS-Downloads/raw/refs/heads/main/Client%20OS/Windows/Windows%2011/25H2/25H2.ps1")
...
'7' { cls
        $Win1126H2 = Invoke-WebRequest ("https://github.com/osdcloudcline/OS-Downloads/raw/refs/heads/main/Client%20OS/Windows/Windows%2011/26H2/26H2.ps1")
        Invoke-Expression $($Win1126H2.Content)
        }
'8' { cls
        $Win1127H2 = Invoke-WebRequest ("https://github.com/osdcloudcline/OS-Downloads/raw/refs/heads/main/Client%20OS/Windows/Windows%2011/27H2/27H2.ps1")
