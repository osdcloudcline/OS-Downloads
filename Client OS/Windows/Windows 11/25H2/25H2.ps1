...
$ZIPDestination = "$env:userprofile\Downloads\OS\Windows11\25H2"

$Windows1125H2URL = "https://github.com/osdcloudcline/OS-Downloads/raw/refs/heads/main/Client%20OS/Windows/Windows%2011/24H2/26100.8313_amd64_en-us_multi_038c7416_convert_virtual.zip"
...
Write-Host "Downloading Windows 11 25H2 ZIP File..." -ForegroundColor Cyan 

Save-WebFile -SourceUrl $Windows1125H2URL -DestinationDirectory $ZIPDestination

pause 

Write-Host "Expanding Windows 11 25H2 ZIP File..." -ForegroundColor Cyan 
...
Write-Host
Write-Host "Downloading Windows 11 25H2 Build: 26200.8313..." -ForegroundColor Cyan 
...
Write-Host "Deleting Subfolders and Files Windows 11 25H2 Source Directory..." -ForegroundColor Cyan 
