...
Write-Host "======= $Title ======"
Write-Host " 1. Client OS Downloads"
Write-Host " 2. Server OS Downloads"
Write-Host " 3. Rescue Media Downloads"
Write-Host " 4. OSDCloud ISO Downloads"
Write-Host " 5. NAS OS Downloads"
...
do 
{
  ...
  {
  '1'{  cls
        $ClientOSDownloadsISO = Invoke-WebRequest("https://github.com/osdcloudcline/OS-Downloads/raw/refs/heads/main/OSDownloadsMain.ps1")
